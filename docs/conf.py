# -*- coding: utf-8 -*-
#
# gs.content.email.base documentation build configuration file, created by
# sphinx-quickstart on Mon Sep 15 10:41:29 2014.
#
...
htmlhelp_basename = 'gscontentemailbasedoc'
...
latex_documents = [
  ('index', 'gscontentemailbase.tex', u'gs.content.email.base Documentation',
...
man_pages = [
    ('index', 'gscontentemailbase', u'gs.content.email.base Documentation',
     [u'GroupServer.org'], 1)
]
...
texinfo_documents = [
  ('index', 'gscontentemailbase', u'gs.content.email.base Documentation',
   u'GroupServer.org', 'gscontentemailbase', 'One line description of project.',
   'Miscellaneous'),
]
